...
if not isfolder("Awe Hub") then
    makefolder("Awe Hub")
end
if not isfolder("Awe Hub/Config") then
    makefolder("Awe Hub/Config")
end
...
local ConfigFile = "Awe Hub/Config/AweHub_" .. gameName .. ".json"
...
local AweHub = {}
function AweHub:MakeNotify(NotifyConfig)
...
function sirenx(msg, delay, color, title, desc)
    return AweHub:MakeNotify({
        Title = title or "Awe Hub",
...
function AweHub:Window(GuiConfig)
    GuiConfig              = GuiConfig or {}
    GuiConfig.Title        = GuiConfig.Title or "Awe Hub"
    GuiConfig.Footer       = GuiConfig.Footer or "Awe Hub"
    GuiConfig.Color        = GuiConfig.Color or Color3.fromRGB(255, 0, 255)
    GuiConfig["Tab Width"] = GuiConfig["Tab Width"] or 120
    GuiConfig.Version      = GuiConfig.Version or 1
    GuiConfig.Image        = GuiConfig.Image or 136987466315529
    ...
    local AweHubGui = Instance.new("ScreenGui");
    local DropShadowHolder = Instance.new("Frame");
    local DropShadow = Instance.new("ImageLabel");
    ...
    AweHubGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
    AweHubGui.Name = "AweHubGui"
    AweHubGui.ResetOnSpawn = false
    AweHubGui.Parent = game:GetService("CoreGui")
    ...
    DropShadowHolder.ZIndex = 0
    DropShadowHolder.Name = "DropShadowHolder"
    DropShadowHolder.Parent = AweHubGui

    DropShadowHolder.Position = UDim2.new(0, (AweHubGui.AbsoluteSize.X // 2 - DropShadowHolder.Size.X.Offset // 2), 0,
        (AweHubGui.AbsoluteSize.Y // 2 - DropShadowHolder.Size.Y.Offset // 2))
    ...
    function GuiFunc:DestroyGui()
        if CoreGui:FindFirstChild("AweHubGui") then
            AweHubGui:Destroy()
        end
    end
    ...
    Close.Activated:Connect(function()
        ...
        Yes.MouseButton1Click:Connect(function()
            if AweHubGui then AweHubGui:Destroy() end
